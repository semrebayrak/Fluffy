...
class ReserveCar extends StatefulWidget {
  @override
  _ReserveCarState createState() => _ReserveCarState();
}
...
class _ReserveCarState extends State<ReserveCar> {
  ...
  Widget build(BuildContext context) {
    ...
    for (var i = 0; i < car.reserved.length; i++) {
      absentDates.add(DateFormat("dd-MM-yyyy").parse(car.reserved[i]));
    }
...
//      firstDayOfWeek: 4,
  ...
  Reserve(DateTime date, Car Car) async {
